...
import PostgresErrorCodes from '../constants/pg-response-codes';
...
export class HttpExceptionFilter implements ExceptionFilter {
    ...
    if (exception?.code == PostgresErrorCodes.ForeignKeyViolation) {
      statusCode = HttpStatus.BAD_REQUEST;
      message = 'This field is being used';
    } else if (exception?.code == PostgresErrorCodes.UniqueViolation) {
